...
export const handler = async (event,data) => {
    ...
    var prompt=`A user is giving feedback on the product: ${product}. The user has provided the following open ended feedback:"${openR}". Generate a set of 3 questions asking for elaboration on their feedback with the goal of eliciting more specific details of their experience with the product.`
